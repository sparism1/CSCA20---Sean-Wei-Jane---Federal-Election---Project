...
master_region_list = [toronto, vancouver, montreal, brampton, calgary, winnipeg, oshawa, victoria, yellowknife]
master_region_list_strings = ("Toronto", "Vancouver", "Montreal", "Brampton", "Calgary", "Winnipeg", "Oshawa", "Victoria", "Yellowknife")
...
print("Welcome to the federal election of 2023! This software will allow the votes to be tallied in the " + str(len(master_region_list)) + " ridings of Canada, and then calculate who wins the general election. Let's get started!")
...
while not master_index == (len(master_region_list)) :
    ...
    while not local_election_over == "true":
        ...
        winning_indexes = []
        #IMPORTANT!!! This next line of code was found online (when researching list comprehension). Reference is in the Github README and the final Project Report.
...
winning_indexes = [] 
#IMPORTANT!!! This next line of code is the same (in essence) to line 65. Look to line 64 for more information.
